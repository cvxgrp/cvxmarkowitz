...
class MaxSharpe(Builder):
    ...
    def __post_init__(self):
        ...
        self.parameter["sigma_max_squared"] = cp.Parameter(
            nonneg=True, name="maximal variance"
        )
        ...
        self.constraints["risk"] = (
            self.model["risk"].estimate(self.variables) <= self.parameter["sigma_max_squared"]
        )
